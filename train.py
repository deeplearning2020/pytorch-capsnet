...
if __name__ == '__main__':
    ...
    train_loader = data.DataLoader(train_data, batch_size=options.batch_size, shuffle=True,  num_workers=4)
    test_data = torchvision.datasets.ImageFolder(root=TEST_DATA_PATH, transform=TRANSFORM_IMG)
    test_loader  = data.DataLoader(test_data, batch_size=options.batch_size, shuffle=True, num_workers=4) 
